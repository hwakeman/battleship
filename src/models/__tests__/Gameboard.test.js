...
describe('allShipsSunk()', () => {
  ...
  beforeEach(() => {
    ...
    exampleGameboard.place(exampleShip, 3, 3, true);
    exampleGameboard.place(exampleShip2, 3, 4, true);
  });
  ...
  test('all sunk', () => {
    ...
    expect(exampleGameboard.allShipsSunk()).toBeTruthy();
  });
  ...
  test('add new ship (all not sunk)', () => {
    ...
    const exampleShip3 = new Ship('example-ship-3', 2);
    exampleGameboard.place(exampleShip3, 3, 5, true);
    expect(exampleGameboard.allShipsSunk()).toBeFalsy();
  });
});
